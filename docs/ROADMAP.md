...
|---|---|---|---|
| Scaffold self-audit & hardening | 🔄 | Repo under git; ROADMAP exists; coexistence + tier rules recorded (ADR 0005/0006); `scripts/check.sh` green; subagent critique run with ALL majors resolved | docs/plans/2026-07-06-scaffold-hardening.md |
